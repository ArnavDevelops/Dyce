    ...
    await Promise.all(
      user.flags.toArray().map(async (badge: any) => {
        if (badge === "PreimumEarlySupporter")
          badges.push(
            "<:Badge_EarlySupporter:1235182582933749861> - Early Supporter"
          );
        if (badge === "ActiveDeveloper")
          badges.push(
            "<:ActiveDeveloper:1234889530700464138> - Active Developer"
          );
        if (badge === "VerifiedBot")
          badges.push(
            "<:Badge_Developer:1234906223942434868> - Verified Bot Developer"
          );
        if (badge === "Partner")
          badges.push("<:Partner_Badge:1234906677522989076> - Discord Partner");
        if (badge === "BugHunterLevel1")
          badges.push(
            "<:Badge_BugHunter:1234907620192682056> - Discord Bug Hunter (Green)"
          );
        if (badge === "BugHunterLevel2")
          badges.push(
            "<:BugHunterLvl2:1234907727046905899> - Discord Bug Hunter (Yellow)"
          );
        if (badge === "CertifiedModerator")
          badges.push(
            "<:Moderator_Programs_Alumni:1234908255554375691> - Moderator Programs Alumni"
          );
        if (badge === "Hypesquad")
          badges.push(
            "<:HypeSquad_Events:1234908937212661801> - Hypesquad Events"
          );
        if (badge === "HypeSquadOnlineHouse1")
          badges.push(
            "<:Hypesquad_Bravery:1235181178974109747> - Hypesquad Bravery"
          );
        if (badge === "HypeSquadOnlineHouse2")
          badges.push(
            "<:Hypesquad_Brilliance:1235180639532224532> - Hypesquad Brilliance"
          );
        if (badge === "HypeSquadOnlineHouse3")
          badges.push(
            "<:Hypesquad_Balance:1235180566715039755> - Hypesquad Balance"
          );
      })
    );
