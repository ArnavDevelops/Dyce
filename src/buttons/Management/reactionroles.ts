...
export default new Button("reactionrole:", async ({ interaction }) => {
  ...
  if (customId.startsWith("reactionrole:role1")) {
  ...
  } else if (customId.startsWith("reactionrole:role2")) {
  ...
  } else if (customId.startsWith("reactionrole:role3")) {
  ...
  } else if (customId.startsWith("reactionrole:role4")) {
